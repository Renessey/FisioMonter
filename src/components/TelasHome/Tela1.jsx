  ...
  return (
    <div className="tela1">
      <div className="info-tela1">
        ...
        <p>
          Bem-vindo(a) à nossa clínica de fisioterapia de última geração, onde
          oferecemos atendimento personalizado e tratamentos eficazes para
          ajudá-lo(a) a alcançar seus objetivos de saúde e bem-estar.
        </p>
